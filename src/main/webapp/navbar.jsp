...
<nav class="navbar navbar-expand-lg navbar-dark dark">
	<a class="navbar-brand" href="index.jsp" style="font-style: italic; font-weight: bold;">Note Taker</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mx-auto">
			<!-- Use mx-auto to center the items -->
...
<!-- Custom CSS to override the purple background -->
<style>
.navbar.dark {
